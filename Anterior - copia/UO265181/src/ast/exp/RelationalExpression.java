...
public class RelationalExpression extends AbstractExp {

	public RelationalExpression(Exp left, String operator, Exp right) {
		this.left = left;
	...
	public RelationalExpression(Object left, Object operator, Object right) {
