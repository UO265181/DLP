...
public class GrammarParser extends Parser {
	...
	public final SentencesContext sentences() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__15) | (1L << T__16) | (1L << T__17) | (1L << T__18) | (1L << T__19) | (1L << T__20) | (1L << T__21) | (1L << T__23) | (1L << T__36) | (1L << INT_CONSTANT) | (1L << REAL_CONSTANT) | (1L << CHAR_CONSTANT) | (1L << IDENT))) != 0)) {
				{
				{
				setState(140);
		...
		try {
			...
			case 2:
				...
				((ExpressionContext)_localctx).access = access(0);
				 ((ExpressionContext)_localctx).ast =  new ExpressionAccess(((ExpressionContext)_localctx).access.ast);
				}
				break;
			case 3:
				{
	...
	private AccessContext access(int _p) throws RecognitionException {
		...
		try {
			...
			((AccessContext)_localctx).IDENT = match(IDENT);
			 ((AccessContext)_localctx).ast =  new AccessVariable(((AccessContext)_localctx).IDENT); 
			}
			_ctx.stop = _input.LT(-1);
			setState(330);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(321);
						match(T__13);
						 ((AccessContext)_localctx).ast =  new AccessArray(((AccessContext)_localctx).array.ast,((AccessContext)_localctx).index.ast); 
					...
					case 2:
						...
						setState(326);
						((AccessContext)_localctx).IDENT = match(IDENT);
						 ((AccessContext)_localctx).ast =  new AccessStructField(((AccessContext)_localctx).struct.ast,((AccessContext)_localctx).IDENT); 
						}
						break;
					}
					} 
