...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, IDENT=14, INT_CONSTANT=15, REAL_CONSTANT=16;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, "IDENT", "INT_CONSTANT", "REAL_CONSTANT"
		};
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__5) | (1L << T__11) | (1L << IDENT) | (1L << INT_CONSTANT) | (1L << REAL_CONSTANT))) != 0)) {
				{
				{
				setState(18);
	...
	public static final String _serializedATN =
		...
		"\2\2\2\"\5\3\2\2\2#$\5\4\3\2$%\7\20\2\2%&\7\7\2\2&\'\b\4\1\2\'\7\3\2\2"+
		...
		"\17\2\29:\b\6\1\2:B\3\2\2\2;<\7\20\2\2<B\b\6\1\2=>\7\21\2\2>B\b\6\1\2"+
		"?@\7\22\2\2@B\b\6\1\2A\65\3\2\2\2A;\3\2\2\2A=\3\2\2\2A?\3\2\2\2BO\3\2"+
