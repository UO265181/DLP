...
public class ExpressionCallFunction extends AbstractExpression {
	...
	public ExpressionCallFunction(String name, List<CallFunctionParam> callFunctionParams) {
		this.name = name;
	...
	public ExpressionCallFunction(Object name, Object callFunctionParams) {
		...
		this.callFunctionParams = this.<CallFunctionParam>getAstFromContexts(callFunctionParams);
	...
	public List<CallFunctionParam> getCallFunctionParams() {
		return callFunctionParams;
	}
	public void setCallFunctionParams(List<CallFunctionParam> callFunctionParams) {
		this.callFunctionParams = callFunctionParams;
	}
	...
	private String name;
	private List<CallFunctionParam> callFunctionParams;
